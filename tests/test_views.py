...
def test_main_page_function_calls(mock_get_stock_prices, mock_get_currency_rates, mock_get_top_trans, mock_get_cards,
                                  mock_get_greeting, mock_filter_by_date, mock_read_excel_file):
    date_input = "2020-05-20 12:00:00"
    ...
    mock_filter_by_date.assert_called_once_with(mock_read_excel_file.return_value, date_input)
