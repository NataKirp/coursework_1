...
def test_save_report():
    """Тестирования сохранения данных в файл."""
...
def test_spending_by_category(sample_transactions):
    """Тестирования вычисления трат по заданной категории и корректности формата выходных данных."""
    result = spending_by_category(
        sample_transactions, "Category1", date="2022-01-04 00:00:00"
    )
    ...
    try:
        ...
        assert result_list == {
            "Category1": [
                {"Описание": "Desc2", "Сумма операции": -200},
                {"Описание": "Desc1", "Сумма операции": -100},
            ]
        }
...
@pytest.mark.parametrize(
    "df_input, category, expected_msg",
    [
        (
            pd.DataFrame(
                {
...
def test_spending_by_category_no_data(df_input, category, expected_msg):
    """Тестирование обработки случаев отсутствия данных за период или отсутствия трат по заданной категории."""
